...
CREATE TYPE "SRActivityType" AS ENUM ('CREATED', 'STATUS_CHANGED', 'PRIORITY_CHANGED', 'ASSIGNED', 'REASSIGNED', 'COMMENTED', 'ATTACHMENT_ADDED', 'ATTACHMENT_REMOVED', 'REOPENED', 'COMPLETED', 'REJECTED', 'INTAKE_UPDATED');
