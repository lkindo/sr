...
describe('SR Actions - Details and Pagination', () => {
    ...
    describe('getSRActivitiesAction', () => {
        it('handles pagination correctly', async () => {
            ...
            const mockActivities = [
                { id: 'act-1', type: 'STATUS_CHANGED', description: 'desc1', createdAt: new Date(), user: { id: 'u1', name: 'N', image: null } },
                { id: 'act-2', type: 'COMMENT_ADDED', description: 'desc2', createdAt: new Date(), user: { id: 'u1', name: 'N', image: null } },
            ];
    ...
    describe('getSRCommentsAction', () => {
        it('handles pagination correctly', async () => {
            const { default: prisma } = await import('@/lib/prisma');
            const mockComments = [
                { id: 'c1', content: 'C1', createdAt: new Date(), updatedAt: new Date(), user: { id: 'u1', name: 'N', image: null } },
                { id: 'c2', content: 'C2', createdAt: new Date(), updatedAt: new Date(), user: { id: 'u1', name: 'N', image: null } },
            ];
