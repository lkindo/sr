...
describe('CreateSRDialog Component', () => {
    ...
    it('successfully submits form when all fields are valid', async () => {
        ...
        fireEvent.change(descInput, { target: { value: 'This is a long enough description for testing.' } });
    ...
    it('handles server side error during creation', async () => {
        ...
        fireEvent.change(screen.getByLabelText(/설명 \*/), { target: { value: 'Long enough description.' } });
