...
| SR 확인완료(CONFIRM)³| 본인 신청 SR | ❌      | ❌             | ✅ 본인 SR     | ✅ 본인 SR     |
...
의견만 남길 수 있다.
³ 확인완료는 신청자 본인만 한다(신원 검사). ADMIN 은 자기가 신청한 SR 만 확인할 수 있고,
MANAGER·ENGINEER 가 자기 이름으로 등록한 SR 은 확인할 사람이 없다 — 고객 요청은 대리 등록으로 올린다.
...
- **확인완료(CONFIRMED)는 고객의 인수 행위**: 신청자 본인만 수행할 수 있으며
  ADMIN·MANAGER·ENGINEER는 대신 확인할 수 없다. 역할 목록이 아니라 **신원(신청자 본인) 검사**로
